...
public class BoardApiController {
    ...
    @GetMapping
    public ResponseEntity<Page<BoardNoCommentDTO>> getBoard(@RequestParam("tabName") String tabName, Pageable pageable) {
        Page<BoardNoCommentDTO> boards = boardService.getBoard(tabName, pageable);
