...
public class CommentTest {
    ...
    public void testSaveComment() {
        ...
        Comment comment = new Comment(0, "Test Comment", LocalDateTime.now(), LocalDateTime.now(), board, user);
    ...
    public void testDeleteComment() {
        ...
        Comment comment = new Comment(0, "Test Comment", LocalDateTime.now(), LocalDateTime.now(), board,  user); // Ensure ID is null
        entityManager.persistAndFlush(comment);
